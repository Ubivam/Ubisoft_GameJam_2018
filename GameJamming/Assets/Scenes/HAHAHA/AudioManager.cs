...
public class AudioManager : MonoBehaviour {
    ...
    public int getMaxValFromArray()
    {
        ...
        sounds[startingIndex].Play();
        for (int i=startingIndex;i<lastIndex+1;i++)
        {
            if( timePressed[i]>=treshold)
            {
                sounds[i].Play();
    ...
    private void identifySongs()
    {
        ...
        Scene level1 = SceneManager.GetSceneByName("Level1");
        Scene level2 = SceneManager.GetSceneByName("Level2");
        /*if (MidiJack.MidiMaster.GetKeyDown("1"))
        {
            if (objpravi.Equals(level1))
            {
        ...
        else if (MidiJack.MidiMaster.GetKeyDown("2"))
        {
            if (objpravi.Equals(level1))
            {
        ...
        else if (MidiJack.MidiMaster.GetKeyDown("3"))
        {
            if (objpravi.Equals(level1))
            {
        ...
        else if (MidiJack.MidiMaster.GetKeyDown("4"))
        {
            if (objpravi.Equals(level1))
            {
        ...
        else if (MidiJack.MidiMaster.GetKeyDown("5"))
        {
            if (objpravi.Equals(level2))
            {
        ...
        */
        ...
        if (objpravi.Equals(level1))
            currLevel = 1;
        int songNum;
        for (int i=InputManager.OFFEST; i<= InputManager.OFFEST+49; i++)
        {
